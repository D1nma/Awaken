...
public class MaterialsPropertiesEditor : Editor
{
    ...
    void OnEnable()
    {
        ...
        surfaceControl = defaultSurface.FindPropertyRelative("control");
        ...
        volumeControl = defaultVolume.FindPropertyRelative("control");
