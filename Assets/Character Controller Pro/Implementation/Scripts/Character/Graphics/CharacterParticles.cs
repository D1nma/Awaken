...
/// </summary>
[AddComponentMenu("Character Controller Pro/Implementation/Character/Character Particles")]
...
{    
    ...
    void OnGroundedStateEnter( Vector3 localVelocity )
    {
        ...
        particlesPooler.Instantiate( 
            particlePosition , 
            particleRotation ,
            characterStateController.CurrentSurface.color , 
            particlesStartSpeed 
        );
    ...
    public void PlayFootstep()
    {
        ...
        float groundedSpeed = CharacterActor.InputVelocity.magnitude;
        particlesPooler.Instantiate( 
            particlePosition , 
            particleRotation ,
            characterStateController.CurrentSurface.color , 
