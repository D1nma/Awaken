...
public sealed class SceneController : MonoBehaviour
{
    ...
    List<KinematicCamera> kinematicCameras = new List<KinematicCamera>();
    ...
    {
        kinematicCameras.Add( kinematicCamera );
    }
    ...
    {
        kinematicCameras.Remove( kinematicCamera );
    }
    ...
    public void Simulate( float dt )
    {
        ...
        for( int i = 0 ; i < kinematicCameras.Count ; i++ )
        {
            KinematicCamera kinematicCamera = kinematicCameras[i];

            if( !kinematicCamera.enabled )
                continue;
            
            kinematicCamera.UpdateKinematicActor( dt );
        }
        ...
        if( useInterpolation )
        {
            ...
            for( int i = 0 ; i < kinematicCameras.Count ; i++ )
            {
                ...
                InterpolateRigidbodyComponent( kinematicCamera.RigidbodyComponent );
            }
