...
public struct LedgeCollisionInfo
{
	public bool leftHandCollision;
	public Vector3 leftHandNormal;

	public bool rightHandCollision;
	public Vector3 rightHandNormal;

	public Vector3 interpolatedLedgeNormal;

	public void Reset()
	{
		leftHandCollision = false;
		leftHandNormal = Vector3.zero;

		rightHandCollision = false;
		rightHandNormal = Vector3.zero;

		interpolatedLedgeNormal = Vector3.zero;
	}

	public void SetCollisionInfo( HitInfo leftHandHitInfo , HitInfo rightHandHitInfo )
	{
		leftHandCollision = leftHandHitInfo.hit;
		leftHandNormal = leftHandHitInfo.normal;

		rightHandCollision = rightHandHitInfo.hit;
		rightHandNormal = rightHandHitInfo.normal;

		interpolatedLedgeNormal = Vector3.Normalize( leftHandNormal + rightHandNormal );
	}
