                        ...
                        for (int k = 0; k < renderersCount; k++) {
                            ...
                            if (renderer != null && renderer.isVisible) {
                                ...
                                if (mat != null) {
                                    ...
                                    overrideMaterial.SetFloat("_AlphaCutOff", manager.alphaCutOff);
                                    if (mat.HasProperty("_BaseMap")) {
                                        overrideMaterial.SetTexture("_MainTex", mat.GetTexture("_BaseMap"));
                                    } else if (mat.HasProperty("_MainTex")) {
                                        overrideMaterial.SetTexture("_MainTex", mat.GetTexture("_MainTex"));
                                    }
