...
namespace VolumetricFogAndMist2 {
    ...
    public partial class VolumetricFog : MonoBehaviour {
        ...
        void LateUpdate() {
            ...
            fogMat.SetFloat("_BoundsVerticalOffset", activeProfile.verticalOffset);
            ...
            windAcum %= 10000;
            fogMat.SetVector("_WindDirection", activeProfile.windDirection * windAcum);
        ...
        void UpdateNoise() {
            ...
            Texture noiseTex = activeProfile.noiseTexture as Texture2D;
            ...
            turbulenceMat.SetFloat("_NoiseStrength", activeProfile.noiseStrength);
            turbulenceMat.SetFloat("_NoiseFinalMultiplier", activeProfile.noiseFinalMultiplier);
            ...
            noiseMat.SetColor("_SpecularColor", activeProfile.specularColor);
            noiseMat.SetFloat("_SpecularIntensity", activeProfile.specularIntensity);
            ...
            fogMat.SetColor("_DetailColor", detailColor);
        }
        ...
        void ApplyProfileSettings() {
            ...
            fogMat.SetFloat("_DeepObscurance", activeProfile.deepObscurance);
            ...
            fogMat.SetFloat("_ShadowIntensity", activeProfile.shadowIntensity);
            fogMat.SetFloat("_Density", activeProfile.density);
            fogMat.SetVector("_RayMarchSettings", new Vector4(activeProfile.raymarchQuality, activeProfile.dithering * 0.01f, activeProfile.jittering, activeProfile.raymarchMinStep));

            if (activeProfile.useDetailNoise) {
                float detailScale = (1f / activeProfile.detailScale) * noiseScale;
                fogMat.SetVector("_DetailData", new Vector4(activeProfile.detailStrength, activeProfile.detailOffset, detailScale, activeProfile.noiseFinalMultiplier));
                fogMat.SetColor("_DetailColor", activeProfile.albedo);
                fogMat.SetFloat("_DetailOffset", activeProfile.detailOffset);
            ...
            if (activeProfile.distance > 0) {
                fogMat.SetVector("_DistanceData", new Vector4(0, 10f * (1f - activeProfile.distanceFallOff), 0, 1f / (0.0001f + activeProfile.distance * activeProfile.distance)));
