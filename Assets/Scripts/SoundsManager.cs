...
public class SoundsManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (!runOnce)
        {
            ...
            if (SceneManager.GetActiveScene().buildIndex == 1 || SceneManager.GetActiveScene().buildIndex == 2) { AkSoundEngine.PostEvent("Menu_Stop", gameObject); AkSoundEngine.PostEvent("Wind_loop_start", gameObject); AkSoundEngine.PostEvent("Birds_Start", gameObject); AkSoundEngine.PostEvent("Lvl1_Start", gameObject); }
            runOnce = true;
        }
    }
